			...
			<main className="grid grid-cols-1 gap-3 w-[375px] p-4 pb-2 content-start relative">
				...
				<div className="px-4 grid grid-rows-1 grid-flow-col gap-4 h-8 justify-items-center">
					<Link href="https://relaxdean.bandcamp.com/" target="_blank">
						<FontAwesomeIcon icon={faBandcamp} color="#FFC74A" size="2x" />
					</Link>

					<FontAwesomeIcon icon={faSpotify} color="#FFC74A" size="2x" />

					<Link href="https://www.youtube.com/@relaxdean" target="_blank">
						<FontAwesomeIcon icon={faYoutube} color="#FFC74A" size="2x" />
					</Link>

					<Link href="https://www.instagram.com/yorelaxdean" target="_blank">
						<FontAwesomeIcon icon={faInstagram} color="#FFC74A" size="2x" />
					</Link>

					<Link href="https://www.tiktok.com/@relaxdeanmusic" target="_blank">
						<FontAwesomeIcon icon={faTiktok} color="#FFC74A" size="2x" />
					</Link>

					<Link href="mailto:relaxdeanmusic@gmail.com" target="_blank">
						<FontAwesomeIcon icon={faEnvelope} color="#FFC74A" size="2x" />
					</Link>
				</div>
